...
public class DrLuckyClient {
    ...
    static GlobalValues gv;

    static JTextArea chatRoom;

    public static void start(JTextArea chatRoom, GlobalValues gv) throws Exception {
        ...
        try {
            ...
            for (;;) {
                System.out.print(""); //Needed because buffer seems messed up without it.
